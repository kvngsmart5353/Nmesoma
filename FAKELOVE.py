...
def logo():
	...
	print("""\x1b[1;92m   ____  _ _                     __    

\x1b[1;93m  / __/ (_|_)_ _  __ _  ___ ____/ /_ __

\x1b[1;96m / _/  / / /  ' \/  ' \/ _ `/ _  / // /

\x1b[1;99m/___/_/ /_/_/_/_/_/_/_/\_,_/\_,_/\_,_/ 
...
def bapi(user):
	...
	if len(name)>=6:
		...
		pwx = [ name, name+"1", name+"12", name+"111", name+"123", name+"1234", name+name, "123456", "223344", "334455", "445566", "password" ]
